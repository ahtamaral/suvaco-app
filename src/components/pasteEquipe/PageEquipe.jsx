        ...
        <section>
            <div className="section-container">
                ...
                <p>
                    ...
                    do Cristo”, um dos responsáveis pela revitalização do carnaval de rua
                    carioca. Através de uma parceria entre a presidência do bloco e o Instituto
                    de Computação (IC/UFRJ), nasceu a ideia de construir um espaço para que essa
                    história seja contada e continuada.
                ...
                era o “sovaco” do Cristo por causa do mofo nos armários de sua casa. O
                quartel-general do bloco era na rua Maria Angélica, localizada em uma linha
                ...
                a comunidade Santa Marta, em Botafogo. Há cerca de vinte anos, a bandeira do
                bloco desfila nas mãos da apresentadora Cynthia Howlett. Da relação com a
                comunidade Santa Marta, surgiu em 2008, a ONG Divinas Axilas que realiza cursos
                e oficinas de corte e costura para mulheres desta e outras comunidades, com foco
                em fantasias de carnaval e de outras festas populares. As oficinas têm como
                objetivo a capacitação e geração de renda para as comunidades.</p>
                ...
                resultado, extenso material estará disponível na rede para consulta por
                pesquisadores e pelo público em geral. Para impulsionar sua divulgação e
                interatividade serão usadas as redes sociais do bloco, da ONG, e do próprio
                ...
                complementam a equipe do projeto, que tem coordenação da professora Anamaria
                Martins Moreira (IC/UFRJ).</p>
                ...
                construção de repositórios e sites estáticos e interativos; preparação
                e divulgação de conteúdo em diversos formatos; diagramação; processos de
                revisão de texto e conteúdo para publicação; digitalização de material
                impresso; interlocução com participantes de diferentes áreas do conhecimento,
                permitindo múltiplas perspectivas sobre curadoria de acervos, preservação e
                divulgação de materiais culturais.</p>
                ...
                para a cidade do Rio de Janeiro: a revitalização do carnaval de rua. Em
                especial, espera-se promover a conscientização sobre a importância da
                cultura e do patrimônio cultural, além de estimular o senso de pertencimento
                à comunidade. A sociedade, por outro lado, tem acesso a um conhecimento
                qualificado e atualizado, que pode ser utilizado para o desenvolvimento de
                políticas públicas, projetos sociais e iniciativas inovadoras.</p>
                ...
                financiamento; desfile; o bloco na mídia; espaço para interação do público
